    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.contenedor}>
          ...
          ></Image>
          <Text style={styles.nombre}>TENS Sofía Rodríguez</Text>
          ...
          ></Image>
          <Text style={styles.nombre}>TENS Mateo García</Text>
          <Text style={styles.descripcion}>
          ...
          ></Image>
          <Text style={styles.nombre}>TENS Valentina Pérez</Text>
          <Text style={styles.descripcion}>
          ...
          ></Image>
          <Text style={styles.nombre}>TENS Alejandro López</Text>
          <Text style={styles.descripcion}>
