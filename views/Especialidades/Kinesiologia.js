    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.contenedor}>
          ...
          ></Image>
          <Text style={styles.nombre}>Kinesióloga Sofía Rodríguez</Text>
          ...
          ></Image>
          <Text style={styles.nombre}>Kinesiólogo Mateo García</Text>
          <Text style={styles.descripcion}>
          ...
          ></Image>
          <Text style={styles.nombre}>Kinesióloga Valentina Pérez</Text>
          <Text style={styles.descripcion}>
