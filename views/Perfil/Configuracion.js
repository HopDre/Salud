...
const Configuracion = () => {
  ...
  const toggleDarkMode = () => {
    ...
    // Aquí deberías aplicar la lógica para cambiar el tema de claro a oscuro en tu aplicación.
    // Puedes utilizar la biblioteca react-native-appearance o implementar tu propia lógica de cambio de tema.
    // Aquí solo estoy cambiando algunos estilos de ejemplo.

    // Ejemplo: Cambiar estilos del fondo de la aplicación
    const updatedStyles = darkMode ? styles.lightMode : styles.darkMode;
    // Aquí deberías actualizar el estado global de la aplicación o el contexto para que los componentes se vuelvan a renderizar con los nuevos estilos.
  };
  return (
