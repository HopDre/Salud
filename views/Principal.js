  ...
  const slides = [
    {
      ...
      content:
        "Te ofrecemos un servicio de calidad y a un costo que esté a tu alcance, nuestro enfoque principal está en tu bienestar",
    },
    {
      image: require("../assets/principal/medicina.png"), // Reemplaza con la ruta de tu segunda imagen
      content:
        "Nuestros especialistas están completamente certificados para brindarte el apoyo de calidad que tu necesitas",
    },
    {
      image: require("../assets/principal/tiempo.png"), // Reemplaza con la ruta de tu tercera imagen
      content:
        "Nuestros servicios son de rápida respuesta, tu solicitas y nosotros respondemos",
    },
  ];
      ...
      <ScrollView>
        ...
        <View style={styles.imgPrincipalDos}>
          ...
          <View style={styles.iconosServicios}>
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate("Enfermeria")}
            >
            <View style={styles.icons}>
              <Image
            ...
            <TouchableOpacity
              onPress={() => navigation.navigate("Kinesiologia")}
            >
            <View style={styles.icons}>
              <Image
