    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <View style={styles.contenedor}>
          ...
          ></Image>
          <Text style={styles.nombre}>Nutricionista Sofía Rodríguez</Text>
          ...
          ></Image>
          <Text style={styles.nombre}>Nutricionista Mateo García</Text>
          <Text style={styles.descripcion}>
          ...
          ></Image>
          <Text style={styles.nombre}>Nutricionista Alejandro López</Text>
          <Text style={styles.descripcion}>
